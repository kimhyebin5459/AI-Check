...
if not os.path.exists("/data/data/com.example.myapplication/files/chaquopy/installed_flag.txt"):
    print("🔧 First-time Python setup…")
    import librosa
    import tensorflow as tf
    import matplotlib.pyplot as plt
    with open("/data/data/com.example.myapplication/files/chaquopy/installed_flag.txt", "w") as f:
        f.write("done")
else:
