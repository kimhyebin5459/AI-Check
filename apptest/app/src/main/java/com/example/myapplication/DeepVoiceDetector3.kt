...
//        MelSpectrogramGenerator.generateMelImage(waveform, melImageFile)
        ...
        // 🔁 Python 호출로 mel-spectrogram 이미지 저장
        val py = Python.getInstance()
        val pyModule = py.getModule("mel_generator_librosa") // ↔ Python 파일 이름: mel_generator.py
        pyModule.callAttr(
            "save_mel_spectrogram_image",
            audioFile.absolutePath,
            melImageFile.absolutePath
        )
