...
export const transactionDetailHandler = http.get('/aicheck/transaction-records/detail', ({ request }) => {
...
export const transactionUpdateHandler = http.patch('/aicheck/transaction-records/update', async ({ request }) => {
  try {
